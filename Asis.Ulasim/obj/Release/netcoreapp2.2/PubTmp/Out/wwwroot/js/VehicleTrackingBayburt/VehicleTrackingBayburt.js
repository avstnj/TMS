try {
    ...
    $(document).ready(function () {
        ...
        $.connection.hub.start().done(function () {
            liveLocationHub.server.joinGroup("ABYS_69");//Bayburt
        });
        ...
        $("#btnShowBusStops").click(function (e) {
            ...
            $.ajax({
                url: "/VehicleTrackingBayburt/GetRouteCoordinat",
                type: "POST",
                data: {
        ...
        var centerPoint = new google.maps.LatLng("40.259092", "40.226867");
        ...
        $.ajax({
            url: "/VehicleTrackingBayburt/GetDepots",
            type: "GET",
            success: function (res) {
                if (res !== "" && res !== "[]") {
    ...
    function getAllLineCoordinates(hatKodu, noRecords, isLast) {
        ...
        $.ajax({
            url: "/VehicleTrackingBayburt/GetRouteGpsCoordinates",
            type: "GET",
            data: {
                hatKodu: hatKodu
            },
