try {
    ...
    $(document).ready(function () {
        ...
        $.connection.hub.url = "http://176.235.94.38:6589/signalr";
        ...
        liveLocationHub.client.broadcastMessage = function (data) {
            ...
            if (data != undefined && data !== "}" && data !== "") {
                ...
                console.log(Now() + '@Localizer["NoData"]'); //" - Veri yok."
            }
            loadPanel.hide();
        };
    ...
    function CreateMarkers(liveTrackingResults) {
        ...
        for (i = 0; i < liveTrackingResults.length; i++) {
            ...
            var markerName = "<b>" + liveTrackingResults[i].validatorNo.toString() + " - " + liveTrackingResults[i].plaka.toString() + " - " + liveTrackingResults[i].hatKodu.toString() + "</b>";
    ...
    function CreateMarkerInfoContent(markerData) {
        var tmp;
        if (markerData.yonStr === null) {
            markerData.yonStr = 'Yönü Seçilmemiş';
        }
