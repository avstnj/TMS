...
var DevExpress = require('@devexpress/analytics-core');
DevExpress.ui = DevExpress.ui || {};
DevExpress.ui.dxTextBox = require('devextreme/ui/text_box');
DevExpress.ui.dxGallery = require('devextreme/ui/gallery');
DevExpress.ui.dxMenu = require('devextreme/ui/menu');
DevExpress.ui.dxPopup = require('devextreme/ui/popup');
DevExpress.utils = DevExpress.utils || {};
DevExpress.utils.browser = require('devextreme/core/utils/browser');
DevExpress.registerComponent = require('devextreme/core/component_registrator');
DevExpress.config = require('devextreme/core/config');

DevExpress.Designer = DevExpress.Designer || {};
DevExpress.Report = DevExpress.Report || {};
module.exports = {
    Designer: DevExpress.Designer,
